    ...
    <div class="max-w-md mx-auto">
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">
          Or
          <a href="/admin/login" class="font-medium text-[#25d366] hover:text-[#1da051]">
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-gray-600">
          ...
          <a href="#" class="font-medium text-[#25d366] hover:text-[#1da051]">Terms of Service</a> 
          and
          <a href="#" class="font-medium text-[#25d366] hover:text-[#1da051]">Privacy Policy</a>.
        </p>
      </div>
    </div>
  </main>
